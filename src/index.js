...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function validateLastName(lastName){
    ...
    if(regEx.test(lastName) === false) return 'The last name you inserted is not valid. Try again.';
  ...
  function validateEmail(email){
    ...
    if(regEx.test(email)) return 'The specified email is invalid. Try again.';
