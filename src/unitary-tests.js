function testNameValidation() {
    console.assert(validateName('') === 'The name field cannot be empty.',
    "The function validateName didn't check if the field of the user name is empty."
    );

    console.assert(validateName('AAAAAAAAAAAAAAAAAAAAA') === 'The name of the client is too long.',
...
function testLastNameValidation() {
    console.assert(validateLastName('') === 'The last name field cannot be empty.',
    "The function validateLastName didn't check if the field of the last name is empty."
    );

    console.assert(validateLastName('AAAAAAAAAAAAAAAAAAAAA') === 'The last name of the client is too long.',
...
function testValidateEmail(){
    console.assert(validateEmail('') === 'The last email field cannot be empty.',
